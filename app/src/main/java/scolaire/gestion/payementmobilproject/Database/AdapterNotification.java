...
public class AdapterNotification extends RecyclerView.Adapter<AdapterNotification.MyViewHolder> {
    ...
    public AdapterNotification(Context context, ArrayList abonner, ArrayList time) {
        this.context = context;
        this.abonner = abonner;
        this.time = time;
    }

    public AdapterNotification(Context context, List<NotificationData> statusList) {
        this.context = context;
...
//        holder.time.setText(classe.getTime());
        ...
        holder.mynom.setText("Id du patient CG "+abonner.get(position));
