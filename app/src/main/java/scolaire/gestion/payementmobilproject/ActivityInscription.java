...
public class ActivityInscription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        mybtn_inscription.setOnClickListener(view -> {Register(adressmail.getText().toString(),password.getText().toString());});
        createRequest();
        findViewById(R.id.google).setOnClickListener(view -> signIn());


        findViewById(R.id.phone_number).setOnClickListener(view -> startActivity(new Intent(ActivityInscription.this,ActivityLoginNumber.class)));
